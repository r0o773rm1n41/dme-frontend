...
export default function RegisterPage() {
  ...
  const [form, setForm] = useState({ 
    ...
    class: "",
    referralCode: "",
    deviceId: "" // will be populated from localStorage
  });
  ...
  // generate or retrieve persistent deviceId for anti-fraud
  useEffect(() => {
  ...
  const handleVerifyEmailOtp = async (e) => {
    ...
    try {
      ...
      const res = await API.post("/auth/register", {
        ...
        ...(form.referralCode && { referralCode: form.referralCode.trim() })
      });
            ...
            <h2>Create Account</h2>
              ...
              <form onSubmit={handleSendOtp}>
                ...
                <div className="input-group">
                  ...
                  <input
                    type="text"
                    placeholder="Enter friend’s referral code if you have one"
                    value={form.referralCode}
                    onChange={(e) => setForm({ ...form, referralCode: e.target.value })}
                  />
                  <small style={{ color: '#666', fontSize: '12px', marginTop: '4px', display: 'block' }}>
                    Using a valid referral code gives you 3 temporary PDF uploads & downloads.
                  </small>
                </div>
